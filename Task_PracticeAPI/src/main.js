...
const getStatusNameStyle = status => {
    const statusMap = {
        'true': {
...
const renderUser = ({name, surname, email, job, company, interests, status, role}) => {
    ...
    <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">${job}</div>
