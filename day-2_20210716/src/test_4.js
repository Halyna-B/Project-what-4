...
describe("Verify that function Palindrome return correct data ", function () {
    ...
    it("Function Palindrome with parameter 199 return type of data number", function () {
        assert.isNumber( Palindrome(199), 'return correct type of data - 99 is a number');
      });

    it("Function Palindrome with parameter 7192 return type of data number ", function () {
        assert.isNumber( Palindrome(7192), 'return correct type of data - 0 is a number');
      });
...
describe("Verify that function Palindrome accepts incorrect data ", function () {
    ...
    it("Function Palindrome accepts incorrect parameter - string '53235107' ", function () {
        assert.equal( Palindrome('53235107'), `{status:'failed', reason:TypeError: function's parameter must be a number, '53235107' is not a number}`);
      });

    it("Function Palindrome accepts incorrect parameter - array [61675555555] ", function () {
        assert.equal( Palindrome([61675555555]), `{status:'failed', reason:TypeError: function's parameter must be a number, [61675555555] is not a number}`);
      });

    it("Function Palindrome accepts incorrect amount of parameters ", function () {
        assert.equal( Palindrome(), `{status:'failed', reason:TypeError: missing 1 required argument, function should accepts a number}`);
      });

    it("Function Palindrome accepts incorrect amount of parameters - two numbers ", function () {
        assert.equal( Palindrome(131, 333333), `{status:'failed', reason:TypeError: function should requires only one parameter }`);
      });
    
    it("Function Palindrome accepts incorrect parameter - float 3.131 ", function () {
        assert.equal( Palindrome(3.131), `{status:'failed', reason:TypeError: function's parameter must be an integer number, 3.131 is not an integer number}`);
      });

    it("Function Palindrome accepts incorrect parameter - negative number -7337351 ", function () {
        assert.equal( Palindrome(-7337351), `{status:'failed', reason:TypeError: function's parameter must be a positive number, -7337351 is a negative number}`);
      });
})